...
<div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Logo Farmácia - Redireciona para /home */}
...
<Link to="/perfil" title="Perfil" className="hover:text-slate-300 transition-colors">
<User size={24} />
</Link>
<Link to="/carrinho" title="Carrinho" className="hover:text-slate-300 transition-colors">
